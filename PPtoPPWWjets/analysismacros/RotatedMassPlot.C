...
void RotatedMassPlot()
{
  ...
  ha1->SetLineWidth(3); ha1->SetLineColor(TColor::GetColor("#d7191c")); ha1->SetMarkerStyle(0); ha1->SetMarkerColor(TColor::GetColor("#d7191c"));
  ...
  ha2->Add(ha2_2);
  ha2->SetLineWidth(3); ha2->SetLineColor(TColor::GetColor("#d7191c")); ha2->SetMarkerStyle(0); ha2->SetMarkerColor(TColor::GetColor("#d7191c"));
  ha1->Add(ha2);
  ...
  hb1->Add(hb1_2);
  hb1->Add(hb1_3);
  hb1->SetLineWidth(3); hb1->SetLineColor(TColor::GetColor("#2b83ba")); hb1->SetMarkerStyle(0); hb1->SetMarkerColor(TColor::GetColor("#2b83ba"));
  ...
  hb2->Add(hb2_2);
  hb2->SetLineWidth(3); hb2->SetLineColor(TColor::GetColor("#2b83ba")); hb2->SetMarkerStyle(0); hb2->SetMarkerColor(TColor::GetColor("#2b83ba"));
  hb1->Add(hb2);
  ...
  hc1->Add(hc1_2);
  hc1->Add(hc1_3);
  hc1->SetLineWidth(3); hc1->SetLineColor(TColor::GetColor("#abdda4")); hc1->SetMarkerStyle(0); hc1->SetMarkerColor(TColor::GetColor("#abdda4"));
  ...
  hc2->Add(hc2_2);
  hc2->SetLineWidth(3); hc2->SetLineColor(TColor::GetColor("#abdda4")); hc2->SetMarkerStyle(0); hc2->SetMarkerColor(TColor::GetColor("#abdda4"));
  hc1->Add(hc2);
  ...
  hd1->Add(hd1_2);
  hd1->Add(hd1_3);
  hd1->SetLineWidth(3); hd1->SetLineColor(TColor::GetColor("#fdae61")); hd1->SetMarkerStyle(0); hd1->SetMarkerColor(TColor::GetColor("#fdae61")); 
  ...
  hd2->Add(hd2_2);
  hd2->SetLineWidth(3); hd2->SetLineColor(TColor::GetColor("#fdae61")); hd2->SetMarkerStyle(0); hd2->SetMarkerColor(TColor::GetColor("#fdae61"));
  hd1->Add(hd2);
