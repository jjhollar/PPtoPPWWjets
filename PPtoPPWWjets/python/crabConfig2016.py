...
#config.General.requestName = 'WWhadronic_Summer16_WJetsToQQ_MadgraphPythia8'                                                                               
#config.General.workArea = '/tmp/jjhollar/WWhadronic_Summer16_WJetsToQQ_MadgraphPythia8'                                                                    
#config.General.requestName = 'WWhadronic_Summer16_ZJetsToQQ_MadgraphPythia8'
#config.General.workArea = '/tmp/jjhollar/WWhadronic_Summer16_ZJetsToQQ_MadgraphPythia8'
#config.General.requestName = 'WWhadronic_Summer16_TTbar700to1000_PowhegPythia8'                                                                             
#config.General.workArea = '/tmp/jjhollar/WWhadronic_Summer16_TTbar700to1000_PowhegPythia8'                                                                  
config.General.requestName = 'WWhadronic_Summer16_TTbar1000toInf_PowhegPythia8'
config.General.workArea = '/tmp/jjhollar/WWhadronic_Summer16_TTbar1000toInf_PowhegPythia8'
...
#config.Data.outLFNDirBase = '/store/user/jjhollar/WWhadronic_Summer16_WJetsToQQ_MadgraphPythia8'
#config.Data.outLFNDirBase = '/store/user/jjhollar/WWhadronic_Summer16_ZJetsToQQ_MadgraphPythia8'                                                           
#config.Data.outLFNDirBase = '/store/user/jjhollar/WWhadronic_Summer16_TTbar700to1000_PowhegPythia8' 
config.Data.outLFNDirBase = '/store/user/jjhollar/WWhadronic_Summer16_TTbar1000toInf_PowhegPythia8'
...
#config.Data.outputDatasetTag = 'WWhadronic_Summer16_WJetsToQQ_MadgraphPythia8'
#config.Data.outputDatasetTag = 'WWhadronic_Summer16_ZJetsToQQ_MadgraphPythia8'                                                                             
#config.Data.outputDatasetTag = 'WWhadronic_Summer16_TTbar700to1000_PowhegPythia8'                        
config.Data.outputDatasetTag = 'WWhadronic_Summer16_TTbar1000toInf_PowhegPythia8'
