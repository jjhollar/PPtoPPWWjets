...
# load common code
if MC == True and UseMCProtons == True and YEAR == 2016 and (ERA == "B" or ERA == "C" or ERA == "G"):
   from direct_simu_reco_2016preTS2_cff import *
if MC == True and UseMCProtons == True and YEAR == 2016 and (ERA == "H"):
   from direct_simu_reco_2016postTS2_cff import *
if MC == True and UseMCProtons == True and YEAR == 2017 and (ERA == "B" or ERA == "C" or ERA == "D"):
   from direct_simu_reco_2017preTS2_cff import *
if MC == True and UseMCProtons == True and YEAR == 2017 and (ERA == "E" or ERA == "F"):
   from direct_simu_reco_2017postTS2_cff import *
if MC == True and UseMCProtons == True and YEAR == 2018:
   from direct_simu_reco_2018_cff import *

if MC == True and UseMCProtons == True:
   process = cms.Process('CTPPSTestAcceptance', era)
if MC == True and UseMCProtons == False:
   process = cms.Process('CTPPSTestAcceptance')
