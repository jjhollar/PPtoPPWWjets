...
void ULPlotStackTest2016(Int_t var = 1)
{
  ...
  */
  ...
  if(var == 35)
    {hist = "htau211antitau"; thetitle = "tau_{21}(j1), anti-tau21"; filetitle = "tau211antitau";}
  if(var == 36)
    {hist = "htau212antitau"; thetitle = "tau_{21}(j2), anti-tau21"; filetitle = "tau212antitau";}
  ...
  */
  ...
  TFile *f100 = TFile::Open("vars_cuts_ntupleULReMiniv4finalWithJERandMultiCand_datahist2016BCG.root");
  TH1F *h100 = (TH1F *)f100->Get(hist);

  TFile *f2 = TFile::Open("vars_cuts_ntupleULReMiniv4finalWithJERandMultiCand_qcdpt300to470_2016.root");
  TH1F *h2 = (TH1F *)f2->Get(hist);

  TFile *f3 = TFile::Open("vars_cuts_ntupleULReMiniv4finalWithJERandMultiCand_qcdpt470to600_2016.root");
  TH1F *h3 = (TH1F *)f3->Get(hist);

  TFile *f4 = TFile::Open("vars_cuts_ntupleULReMiniv4finalWithJERandMultiCand_qcdpt600to800_2016.root");
  TH1F *h4 = (TH1F *)f4->Get(hist);
  
  TFile *f5 = TFile::Open("vars_cuts_ntupleULReMiniv4finalWithJERandMultiCand_qcdpt800to1000_2016.root");
  TH1F *h5 = (TH1F *)f5->Get(hist);
  
  TFile *f6 = TFile::Open("vars_cuts_ntupleULReMiniv4finalWithJERandMultiCand_qcdpt1000to1400_2016.root");
  TH1F *h6 = (TH1F *)f6->Get(hist);

  TFile *f7 = TFile::Open("vars_cuts_ntupleULReMiniv4finalWithJERandMultiCand_ttbarhadronic1000inf_2016.root");
  TH1F *h7 = (TH1F *)f7->Get(hist);

  TFile *f8 = TFile::Open("vars_cuts_ntupleULReMiniv4finalWithJERandMultiCand_wjetshadronic_2016.root");
  TH1F *h8 = (TH1F *)f8->Get(hist);

  TFile *f9 = TFile::Open("vars_cuts_ntupleULReMiniv4finalWithJERandMultiCand_zjetshadronic_2016.root");
  TH1F *h9 = (TH1F *)f9->Get(hist);

  TFile *f10 = TFile::Open("vars_cuts_ntupleULReMiniv4finalWithJERandMultiCand_qcdpt1400to1800_2016.root");
  ...
  TFile *fd1 = TFile::Open("vars_cuts_ntupleULReMiniv4finalWithJERandMultiCand_exclWWACW2E-5_2016preTS2.root");
  ...
  if(var == 3 || var == 6 || var == 7 || var == 8 || var == 9 || var == 18 || var == 19 || var == 20 || var == 16 || var == 25 || var == 26 || (var > 21))
	...
	rebinfactor = 1;
      ...
      ha1->Rebin(rebinfactor); hd1->Rebin(rebinfactor);
    }
  ...
  hd1->Scale(mcdxsec*1000*lumi/63400.0);
