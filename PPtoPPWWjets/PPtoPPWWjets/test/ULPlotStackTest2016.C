...
void ULPlotStackTest2016(Int_t var = 1)
{
  ...
  */
  ...
  TFile *f100 = TFile::Open("vars_cuts_ntupleULReMiniv4final_datahist2016BCGH.root");
  TH1F *h100 = (TH1F *)f100->Get(hist);

  //  TFile *f2 = TFile::Open("vars_cuts_ntupleULReMiniv4final_qcdpt300to470_2016.root");
  //  TH1F *h2 = (TH1F *)f2->Get(hist);

  TFile *f3 = TFile::Open("vars_cuts_ntupleULReMiniv4final_qcdpt470to600_2016.root");
  TH1F *h3 = (TH1F *)f3->Get(hist);

  TFile *f4 = TFile::Open("vars_cuts_ntupleULReMiniv4final_qcdpt600to800_2016.root");
  TH1F *h4 = (TH1F *)f4->Get(hist);
  
  TFile *f5 = TFile::Open("vars_cuts_ntupleULReMiniv4final_qcdpt800to1000_2016.root");
  TH1F *h5 = (TH1F *)f5->Get(hist);
  
  TFile *f6 = TFile::Open("vars_cuts_ntupleULReMiniv4final_qcdpt1000to1400_2016.root");
  TH1F *h6 = (TH1F *)f6->Get(hist);

  TFile *f7 = TFile::Open("vars_cuts_ntupleULReMiniv4final_ttbarhadronic1000inf_2016.root");
  TH1F *h7 = (TH1F *)f7->Get(hist);

  TFile *f8 = TFile::Open("vars_cuts_ntupleULReMiniv4final_wjetshadronic_2016.root");
  TH1F *h8 = (TH1F *)f8->Get(hist);

  TFile *f9 = TFile::Open("vars_cuts_ntupleULReMiniv4final_zjetshadronic_2016.root");
  TH1F *h9 = (TH1F *)f9->Get(hist);

  TFile *f10 = TFile::Open("vars_cuts_ntupleULReMiniv4final_qcdpt1400to1800_2016.root");
