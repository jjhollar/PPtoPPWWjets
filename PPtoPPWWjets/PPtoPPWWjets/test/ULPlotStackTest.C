...
void ULPlotStackTest(Int_t var = 1)
{
  ...
  */
  ...
  TFile *f2 = TFile::Open("vars_cuts_ntupleULReMiniv4final_qcdpt300to470.root");
  TH1F *h2 = (TH1F *)f2->Get(hist);

  TFile *f3 = TFile::Open("vars_cuts_ntupleULReMiniv4final_qcdpt470to600.root");
  TH1F *h3 = (TH1F *)f3->Get(hist);

  TFile *f4 = TFile::Open("vars_cuts_ntupleULReMiniv4final_qcdpt600to800.root");
  TH1F *h4 = (TH1F *)f4->Get(hist);
  
  TFile *f5 = TFile::Open("vars_cuts_ntupleULReMiniv4final_qcdpt800to1000.root");
  TH1F *h5 = (TH1F *)f5->Get(hist);
  
  TFile *f6 = TFile::Open("vars_cuts_ntupleULReMiniv4final_qcdpt1000to1400.root");
  TH1F *h6 = (TH1F *)f6->Get(hist);

  TFile *f7 = TFile::Open("vars_cuts_ntupleULReMiniv4final_ttbarhadronic.root");
  TH1F *h7 = (TH1F *)f7->Get(hist);

  TFile *f8 = TFile::Open("vars_cuts_ntupleULReMiniv4final_wjetshadronic.root");
  TH1F *h8 = (TH1F *)f8->Get(hist);

  TFile *f9 = TFile::Open("vars_cuts_ntupleULReMiniv4final_zjetshadronic.root");
  TH1F *h9 = (TH1F *)f9->Get(hist);

  TFile *f10 = TFile::Open("vars_cuts_ntupleULReMiniv4final_qcdpt1400to1800.root");
