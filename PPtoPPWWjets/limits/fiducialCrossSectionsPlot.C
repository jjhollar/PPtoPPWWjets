...
void fiducialCrossSectionsPlot() {
  ...
  cout << "Mean value for WW: " << TMath::Mean(ww_points, fxs) << " (+" << TMath::Mean(ww_points, fxs_plusSigma) - TMath::Mean(ww_points, fxs) << "/-"
       << TMath::Mean(ww_points, fxs) - TMath::Mean(ww_points, fxs_minusSigma) << ")" << endl;
  cout << "Mean value for ZZ: " << TMath::Mean(zz_points, fxs+ww_points) << " (+" << TMath::Mean(zz_points, fxs_plusSigma+ww_points) - TMath::Mean(zz_points, fxs+ww_points) << "/-"
       << TMath::Mean(zz_points, fxs+ww_points) - TMath::Mean(zz_points, fxs_minusSigma+ww_points) << ")" << endl;
}